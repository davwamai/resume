...
\begin{document}
  ...
  \section{Skills}
    \cvitem{Languages}{C/C++, Python, bash, Verilog, AWK, Assembly(ARM/x86), MATLAB/Octave}
    \cvitem{Softwares}{Vivado, Fusion360/FreeCAD, MATLAB}

	\section{Research Experience}
    \cvitem{2022 - Present}{\textbf{Research Assistant, Adaptive Real-Time Systems Laboratory}, University of South Carolina Columbia.}
    \begin{itemize}
    \item Conducted research on real-time systems with a focus on embedded platforms and adaptive algorithms.
    \item Developed and tested prototype implementations to evaluate system performance under varying constraints.
  ...
  \section{Non-Academic Experience}
    \cvitem{2024 - Present}{\textbf{Contractor}, Inventions Unlimited, LLC. Columbia, SC.}
    \begin{itemize}
    \item Designed and developed embedded systems and Linux applications for commercial and consumer applications.
    \item Worked closely with cross-functional teams to integrate hardware and software solutions with a focus on Artificial Intelligence/Machine Learning.
    \item Implemented firmware for microcontrollers and SoCs, optimizing for low power consumption and real-time processing.
    \item Conducted thorough testing and debugging to ensure system stability and functionality.
    \end{itemize}

  \section{Awards and Honors}
  \cvitem{May, 2023}{NASA South Carolina Space Grant Consortium Undergraduate Student Research Award}
  \cvitem{May, 2023}{National Science Foundation, United States Grant Number 2152896}
  \cvitem{September, 2023}{National Science Foundation, United States Grant Number 2237696}
  \cvitem{April, 2024}{National Science Foundation, United States Grant Number 2344357}
  \cvitem{May, 2024}{McNAIR Junior Fellowship Program}
